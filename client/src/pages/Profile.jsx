  ...
  return (
    <div >
      ...
      <div style={styles.Box1} className="Box1">
        ...
        <br />
        <h1 style={{ fontFamily: 'Arial', fontSize: '18px', fontWeight: 'bold', textAlign: 'center' }}>To Do</h1>
        <div style={styles.scrollableTable2}>
          <table style={styles.table}>
            <thead>
              <tr>
                <th style={styles.dateColumn}>Date</th>
                <th style={styles.reasonColumn}>Task</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td style={styles.tableData}>01/01/23</td>
                <td style={styles.tableData}>Sign document</td>
              </tr>
              <tr>
                <td style={styles.tableData}>01/01/23</td>
                <td style={styles.tableData}>Sign document</td>
        ...
        <div style={styles.scrollableTable}>
          <table style={styles.table}>
            <thead>
              <tr>
                <th style={styles.dateColumn}>Date</th>
                <th style={styles.doctorColumn}>Patient</th>
